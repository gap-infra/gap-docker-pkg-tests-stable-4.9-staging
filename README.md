[![Build Status](https://travis-ci.org/gap-system/gap-docker-pkg-tests-stable-4.9-staging.svg?branch=master)](https://travis-ci.org/gap-system/gap-docker-pkg-tests-stable-4.9-staging)
...
tests are in https://github.com/gap-system/gap-docker-pkg-tests-stable-4.9.
